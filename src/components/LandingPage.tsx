  ...
  return (
    <div className="flex flex-row h-screen w-screen overflow-hidden">
      ...
      <div className="flex flex-col h-screen w-[75%]">
        <div className="flex flex-row mt-[2rem] ml-[5rem] w-full">
            ...
            <button style={{cursor:"none"}} className="place-self-end font-press-start mx-[1rem] py-[0.5rem] px-[2rem] justify-end border-2 focus:outline-none border-white rounded-md transition-all duration-300 ease-in-out hover:scale-110  hover:bg-white hover:text-black"
